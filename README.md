...
|------|--------------|-----------|
| [`essential-attention/`](essential-attention/) | AXM Case Ledger for the FAB aftermath: exact SCG mark, case topology, dark custody shell, paper dossier, seven source-linked objects, five bounded decisions, contained functional seats, guided first use, cold handoff, and portable export without external-effect adapters | [standalone FAB case ledger](https://bigbirdreturns.github.io/axm-tools/essential-attention/) — opens with Start here, first-run help, and a guided tour |
