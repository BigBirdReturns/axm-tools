...
|------|--------------|-----------|
| [`manzanita/`](manzanita/) | Public-safe household-to-region place fabric with seven scales, eight independent conditions, five functional perspectives, assistance-first horticultural and wildfire remediation, explicit purpose limits, shareable state, and an Essential Attention handoff | [Signal Sheet v1.4.1](https://bigbirdreturns.github.io/axm-tools/manzanita/) |
