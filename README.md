...
|------|--------------|-----------|
| [`essential-attention/`](essential-attention/) | AXM Operating Cockpit for the FAB aftermath: exact SCG mark, case topology, role-aware Operations home, six-step setup assistant, persistent guidance, attention routing, process-board and list views, guided record paths, five bounded decisions, contained functional seats, cold handoff, and portable export without external-effect adapters | [standalone FAB operating cockpit](https://bigbirdreturns.github.io/axm-tools/essential-attention/) — opens with Guided setup, Operations home, persistent guidance, and a complete operating loop |
