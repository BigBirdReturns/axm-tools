...
| [`venture-spine/`](venture-spine/) | Local external-state governance workbench for hard-technology companies: reconstructs counterparties, instruments, claims, evidence, rights, authority, decisions, settlement, correction, and succession as separate objects; starts with one recommended action; hashes local sources without retaining bytes; drafts rationale-bearing decisions; refuses tampered or duplicate packets; exports public/private packets; creates encrypted backups; runs no-total-score stress cases and cold-successor replay; and cannot execute an external effect | [Venture Spine 1.0.0](https://bigbirdreturns.github.io/axm-tools/venture-spine/) — Pelagos public-safe cartridge, 188 static checks, 47 public-contract checks, 12 fixture checks, 71 browser checks, 72 embedded self-test cells, and cache-bypassed live readback |
