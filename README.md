...
|------|--------------|-----------|
| [`essential-attention/`](essential-attention/) | Local-first FAB aftermath case file: seven source-linked administrative objects, five bounded decisions, contained functional seats, guided first use, cold handoff, and portable export without external-effect adapters | [standalone FAB runtime](https://bigbirdreturns.github.io/axm-tools/essential-attention/) — opens with Start here, first-run help, and a guided tour |
