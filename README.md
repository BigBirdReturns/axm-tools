...
|------|--------------|-----------|
| [`shelf/`](shelf/) | Claims about compute filed side by side: a five-question card format, a stdlib validator, mechanical refusal of invalid compositions, a "which cards can support this question" check, and a pull rule that imports other hubs' shelves as candidates without granting standing | [The shelf](https://bigbirdreturns.github.io/axm-tools/shelf/) — five cards, two model-stranger filings retained, nothing ranks |
...
| [`manzanita-works/`](manzanita-works/) | Public-safe interactive Operating Fabric dreamboard that maps tools, time, talent, pilotage, mobility, prevention and support, stewardship, and money into one institutional substrate while keeping fundraising as a subordinate view | [Operating Fabric Dreamboard v0.2.0](https://bigbirdreturns.github.io/axm-tools/manzanita-works/?focus=fundraising) |
...
| [`case-zero/`](case-zero/) | Local external-qualification workbench for one failed client engagement: hashes selected evidence in the browser, exposes credential and PII-shaped holds, projects the ten bounded reconstruction jobs, and exports body-free or pseudonymized review packets without uploading source files | [standalone Case Zero workbench](https://bigbirdreturns.github.io/axm-tools/case-zero/) — no account, upload, model call, client contact, or source-system writeback |
| [`pelagos-governance/`](pelagos-governance/) | Venture Spine public-safe Pelagos Governance Layer: reconstructs counterparties, instruments, claims, evidence, rights, authority and founder decisions from the visible company state; separates technical maturity from economic force and operational authority; provides local intake and correction without external-effect adapters | [Pelagos Governance Layer](https://bigbirdreturns.github.io/axm-tools/pelagos-governance/) — public baseline only; private Pelagos state remains outside the repo |
| [`axm-witness/`](axm-witness/) | Department-controlled local export-ledger pilot for authorized Flock-shaped exports: exact source custody, signed evidence and human-decision history, rationale-bearing review, tamper detection, encrypted backup and same-key restoration, interrupted-import recovery, duplicate refusal, and replacement lineage | [AXM Witness Department Ledger 0.9.2](https://bigbirdreturns.github.io/axm-tools/axm-witness/) — 30/30 native qualification; upstream delivery completeness remains outside the ledger |
